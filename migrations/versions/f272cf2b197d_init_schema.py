...
Revision ID: f272cf2b197d
Revises: 
Create Date: 2025-09-07 08:45:56.448033
...
def upgrade():
    ...
    sa.Column('es_publico', sa.Boolean(), nullable=True),
    ...
    sa.Column('widget_icon_url', sa.String(length=255), nullable=True),
    sa.Column('widget_animation', sa.String(length=100), nullable=True),
    ...
    sa.Column('id', sa.String(length=36), nullable=False),
    sa.Column('pyme_id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=255), nullable=False),
    sa.Column('mapping', sa.JSON(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['pyme_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    with op.batch_alter_table('catalog_mapping', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_catalog_mapping_pyme_id'), ['pyme_id'], unique=False)
    ...
    sa.Column('consulta_pin', sa.String(length=6), nullable=False),
    ...
    sa.Column('dni_vecino', sa.String(length=20), nullable=True),
    sa.Column('foto_url_directa', sa.String(length=255), nullable=True),
    sa.Column('canal_ingreso', sa.String(length=50), nullable=True),
    sa.Column('contacto_seguimiento', sa.String(length=255), nullable=True),
    sa.Column('nombre_display_whatsapp', sa.String(length=150), nullable=True),
    sa.Column('url_avatar_whatsapp', sa.String(length=255), nullable=True),
    ...
    sa.Column('archivo_adjunto_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['archivo_adjunto_id'], ['archivo_adjunto.id'], ),
    sa.ForeignKeyConstraint(['municipio_ticket_id'], ['municipio_ticket.id'], ),
    sa.ForeignKeyConstraint(['pyme_ticket_id'], ['pyme_ticket.id'], ),
    sa.PrimaryKeyConstraint('id')
...
def downgrade():
    ...
    with op.batch_alter_table('catalog_mapping', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_catalog_mapping_pyme_id'))
