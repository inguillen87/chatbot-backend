...
class ApiV2FoundationTest(unittest.TestCase):
    ...
    def test_v2_demo_session_returns_workspace_contract(self):
        ...
        self.assertEqual((whatsapp_sandbox.get("trial_policy") or {}).get("free_inputs"), ["text", "image", "audio", "location", "file"])
    ...
    def test_public_whatsapp_sandbox_launcher_requires_no_auth_and_exposes_trial_contract(self):
        ...
        self.assertEqual((contract.get("trial_policy") or {}).get("free_inputs"), ["text", "image", "audio", "location", "file"])
