...
from tests.crm_task_rollout_invariants import RolloutInvariantTests

class CrmTaskHttpTests(TaskInvariantTests, RolloutInvariantTests, unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        cls.app.config['CRM_TASKS_TENANT_IDS'] = ','.join(str(cls.accounts[slug]['tenant_id']) for slug in ('acceptance-a','acceptance-b'))
