...
class CrearReclamoActionHandler(BaseActionHandler):
    ...
    @patch('services.actions.municipio_actions.formatear_telefono_e164')
    @patch('services.herramientas_municipio.parse_direccion_completa')
    def test_crear_reclamo_sin_archivos_limpia_contexto(
        self,
        mock_parse_direccion,
        mock_formatear_tel,
        mock_enviar_whatsapp,
        ...
        context = {
            ...
            "municipio_config_actual": {"ejemplo_direccion": "Av. Siempreviva 742"},
            "chat_session_uuid": "sess-abc",
            "chat_db_context_data": {"processed_idempotency_keys": {}, "ids_archivos_para_asociar": []},
        ...
        mock_asociar_archivos.assert_not_called()
        self.assertNotIn("ids_archivos_para_asociar", context)
        self.assertNotIn("archivo_id_para_asociar", context)
        self.assertNotIn("ids_archivos_para_asociar", context.get("chat_db_context_data", {}))
        self.assertNotIn("archivo_id_para_asociar", context.get("chat_db_context_data", {}))
