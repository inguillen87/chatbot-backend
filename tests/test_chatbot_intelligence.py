...
def test_image_analysis_reclamo_municipio(mock_interpretar_imagen, mock_handle_llm, client, mock_db_session):
...
@patch('services.municipio_responder.handle_llm_interaction')
def test_information_gathering_reclamo_municipio(mock_handle_llm, client, mock_db_session):
