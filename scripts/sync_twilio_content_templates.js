...
const templates = [
  ...
  },
  {
    ...
    variables: { "1": "PED-1001", "2": "$25.000", "3": "cuatro-fincas" },
    types: (body) => withCta(body, "Pagar seguro", `${DEFAULT_BASE_URL}/t/{{3}}/checkout`),
  },
  {
  ...
  },
  {
    ...
    types: (body) => withCta(body, "Pagar cuota", `${DEFAULT_BASE_URL}/t/{{2}}/checkout`),
  },
  {
  ...
  },
  {
    ...
    variables: { "1": "PED-1001", "2": "$25.000", "3": "cuatro-fincas" },
    types: (body) => withCta(body, "Pagar pedido", `${DEFAULT_BASE_URL}/t/{{3}}/checkout`),
  },
  {
    ...
    variables: { "1": "Marcelo", "2": "$25.000", "3": "cuatro-fincas" },
    types: (body) => withCta(body, "Pagar seguro", `${DEFAULT_BASE_URL}/t/{{3}}/checkout`),
  },
  {
  ...
  },
  {
    ...
    types: (body) => withCta(body, "Ver catalogo", `${DEFAULT_BASE_URL}/t/{{2}}/market`),
  },
  {
    name: "chatboc_finance_account_onboarding_v1",
    category: "UTILITY",
    body: "Hola {{1}}, tu alta digital en {{2}} esta lista para revisar. Continua desde el boton seguro. No envies documentos completos ni claves por chat.",
    variables: { "1": "Marcelo", "2": "banco-demo", "3": "ONB-1001", "4": "session-demo-123456" },
    types: (body) => withCta(body, "Abrir alta", `${DEFAULT_BASE_URL}/finanzas/{{2}}/alta/{{3}}?session={{4}}`),
  },
  {
    name: "chatboc_finance_kyc_review_v1",
    category: "UTILITY",
    body: "Necesitamos que revises la validacion de identidad {{1}} en {{2}}. Usa el boton seguro para continuar.",
    variables: { "1": "ONB-1001", "2": "banco-demo", "3": "session-demo-123456" },
    types: (body) => withCta(body, "Revisar identidad", `${DEFAULT_BASE_URL}/finanzas/{{2}}/alta/{{1}}?session={{3}}`),
  },
  {
    name: "chatboc_finance_credit_offer_v1",
    category: "UTILITY",
    body: "{{1}}, tenes una propuesta de credito en {{2}}. Revisala desde el boton seguro antes de aceptar condiciones.",
    variables: { "1": "Marcelo", "2": "banco-demo", "3": "CRE-1001", "4": "session-demo-123456" },
    types: (body) => withCta(body, "Ver propuesta", `${DEFAULT_BASE_URL}/finanzas/{{2}}/operacion/{{3}}?session={{4}}`),
  },
  {
    name: "chatboc_finance_collection_due_v1",
    category: "UTILITY",
    body: "{{1}}, registramos una cobranza pendiente en {{2}}. Podes revisar monto, vencimiento y opciones desde el boton seguro.",
    variables: { "1": "Marcelo", "2": "banco-demo", "3": "COB-1001", "4": "session-demo-123456" },
    types: (body) => withCta(body, "Revisar cobranza", `${DEFAULT_BASE_URL}/finanzas/{{2}}/operacion/{{3}}?session={{4}}`),
  },
  {
    name: "chatboc_finance_secure_payment_v1",
    category: "UTILITY",
    body: "Tu pago seguro {{1}} en {{2}} esta disponible. No compartas datos de tarjeta por WhatsApp.",
    variables: { "1": "PAY-1001", "2": "banco-demo", "3": "session-demo-123456" },
    types: (body) => withCta(body, "Pagar seguro", `${DEFAULT_BASE_URL}/finanzas/{{2}}/operacion/{{1}}?session={{3}}`),
  },
  {
    name: "chatboc_finance_document_signature_v1",
    category: "UTILITY",
    body: "Documento {{1}} pendiente de firma en {{2}}. Leelo y confirma desde la vista segura.",
    variables: { "1": "DOC-1001", "2": "banco-demo", "3": "session-demo-123456" },
    types: (body) => withCta(body, "Firmar seguro", `${DEFAULT_BASE_URL}/finanzas/{{2}}/operacion/{{1}}?session={{3}}`),
  },
  {
    name: "chatboc_finance_support_case_v1",
    category: "UTILITY",
    body: "Creamos el caso financiero {{1}} en {{2}}. Podes seguirlo o pedir ayuda sin compartir datos sensibles por chat.",
    variables: { "1": "FIN-1001", "2": "banco-demo", "3": "session-demo-123456" },
    types: (body) => withCta(body, "Ver caso", `${DEFAULT_BASE_URL}/finanzas/{{2}}/operacion/{{1}}?session={{3}}`),
  },
  {
    name: "chatboc_finance_account_status_v1",
    category: "UTILITY",
    body: "El estado de cuenta {{1}} en {{2}} esta disponible. Consulta el detalle desde la vista segura.",
    variables: { "1": "CTA-1001", "2": "banco-demo", "3": "session-demo-123456" },
    types: (body) => withCta(body, "Ver cuenta", `${DEFAULT_BASE_URL}/finanzas/{{2}}/cuentas/{{1}}?session={{3}}`),
  },
  {
    name: "chatboc_finance_remittance_transfer_v1",
    category: "UTILITY",
    body: "Transferencia {{1}} en {{2}} lista para revisar. Valida destinatario y comprobante desde el boton seguro.",
    variables: { "1": "TRF-1001", "2": "banco-demo", "3": "session-demo-123456" },
    types: (body) => withCta(body, "Ver transferencia", `${DEFAULT_BASE_URL}/finanzas/{{2}}/transferencias/{{1}}?session={{3}}`),
  },
  {
    name: "chatboc_finance_insurance_claim_v1",
    category: "UTILITY",
    body: "Siniestro {{1}} registrado en {{2}}. Adjunta documentacion y revisa estado desde la vista segura.",
    variables: { "1": "SIN-1001", "2": "banco-demo", "3": "session-demo-123456" },
    types: (body) => withCta(body, "Ver siniestro", `${DEFAULT_BASE_URL}/finanzas/{{2}}/seguros/{{1}}?session={{3}}`),
  },
  {
    name: "chatboc_finance_fee_financing_v1",
    category: "UTILITY",
    body: "Plan de financiacion {{1}} disponible en {{2}}. Revisa cuotas y condiciones desde el boton seguro.",
    variables: { "1": "FIN-PLAN-1001", "2": "banco-demo", "3": "session-demo-123456" },
    types: (body) => withCta(body, "Ver plan", `${DEFAULT_BASE_URL}/finanzas/{{2}}/financiacion/{{1}}?session={{3}}`),
  },
  {
    name: "chatboc_finance_tax_payment_v1",
    category: "UTILITY",
    body: "Pago de tasa o impuesto {{1}} disponible en {{2}}. Revisa el detalle y paga desde la vista segura.",
    variables: { "1": "TAX-1001", "2": "banco-demo", "3": "session-demo-123456" },
    types: (body) => withCta(body, "Ver pago", `${DEFAULT_BASE_URL}/finanzas/{{2}}/financiacion/{{1}}?session={{3}}`),
  },
  {
