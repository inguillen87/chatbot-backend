...
# Conditional import and monkey-patching for eventlet
if os.environ.get("FLASK_ENV") not in ["testing", "test", "development_local"] and os.environ.get("FLASK_APP_TYPE") != "celery":
