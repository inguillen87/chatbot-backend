...
- `POST /api/whatsapp/promocionar` – broadcast a flyer to all users who consented
  to marketing. Accepts `titulo`, `descripcion`, `link` and `url_imagen` (or a
  prebuilt `mensaje`). Limited to one send per day.
