...
class Config:
    ...
    LIVE_CHAT_SCHEDULE_ENABLED = os.getenv("LIVE_CHAT_SCHEDULE_ENABLED", "true").lower() in ("true", "1", "yes")
    LIVE_CHAT_SCHEDULE_DAYS = os.getenv("LIVE_CHAT_SCHEDULE_DAYS", "mon-fri")
    LIVE_CHAT_SCHEDULE_TIMEZONE = os.getenv("LIVE_CHAT_SCHEDULE_TIMEZONE", "America/Argentina/Buenos_Aires")
    LIVE_CHAT_SCHEDULE_START_HOUR = int(os.getenv("LIVE_CHAT_SCHEDULE_START_HOUR", "9"))
    LIVE_CHAT_SCHEDULE_START_MINUTE = int(os.getenv("LIVE_CHAT_SCHEDULE_START_MINUTE", "0"))
    LIVE_CHAT_SCHEDULE_END_HOUR = int(os.getenv("LIVE_CHAT_SCHEDULE_END_HOUR", "13"))
    LIVE_CHAT_SCHEDULE_END_MINUTE = int(os.getenv("LIVE_CHAT_SCHEDULE_END_MINUTE", "0"))
    LIVE_CHAT_AUTO_URGENCY_KEYWORDS = os.getenv("LIVE_CHAT_AUTO_URGENCY_KEYWORDS", "")
