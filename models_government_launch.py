...
class TenantBlueprintLaunchReceipt(db.Model):
    """Append-only receipt for one tenant blueprint launch module."""

    __tablename__ = "tenant_blueprint_launch_receipt"
    ...
    blueprint_application_id = db.Column(
        db.String(36),
        db.ForeignKey("tenant_blueprint_application.id", ondelete="RESTRICT"),
        nullable=False,
        index=True,
    )
    ...
    launch_id = db.Column(db.String(64), nullable=False)
    manifest_digest = db.Column(db.String(64), nullable=False)
    launch_digest = db.Column(db.String(64), nullable=False)
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "blueprint_application_id": self.blueprint_application_id,
