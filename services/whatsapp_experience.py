    ...
    *,
    ...
    flows = [
        ...
        },
        {
            ...
            "url_template": "/chat/{ticket_id}?pin={pin}&mode=claim_helpdesk",
            "requires": ["ticket_id", "pin", "tenant_slug"],
            "signed_params": ["tenant_slug", "ticket_id", "pin", "contact_key", "expires_at"],
