...
ACTION_HANDLER_MAP = {
    ...
    "pyme_menu_principal": "services.actions.pyme_actions.MenuPrincipalHandler",
    "pyme_ver_carrito": "services.actions.pyme_actions.VerCarritoHandler",
    "pyme_agregar_carrito": "services.actions.pyme_actions.AgregarCarritoHandler",
    "pyme_vaciar_carrito": "services.actions.pyme_actions.VaciarCarritoHandler",
    "pyme_finalizar_compra": "services.actions.pyme_actions.FinalizarCompraHandler",
}
