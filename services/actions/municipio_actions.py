...
class DerivarHumanoActionHandler(BaseActionHandler):
    def execute(self, action_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            contacto_context = {}
            municipal_ctx = self.context.get(CONTEXTO_MUNICIPIO) or {}
            contacto_context.update(municipal_ctx.get("contacto_usuario") or {})
            chat_ctx_data = self.context.get("chat_db_context_data") or {}
            if not contacto_context and isinstance(chat_ctx_data, dict):
                contacto_context.update(
                    (chat_ctx_data.get(CONTEXTO_MUNICIPIO, {}) or {}).get("contacto_usuario", {})
                )
            ...
            nombre_display = nombre or "Vecino"
            ...
            ticket_data = {
                ...
                "nombre_vecino": nombre or nombre_display,
