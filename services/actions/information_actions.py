...
class ConsultarComerciosActionHandler(BaseActionHandler):
    def execute(self, action_data: Dict[str, Any]) -> Dict[str, Any]:
        logger.info(f"Executing ConsultarComerciosActionHandler with data: {action_data}")

        categoria = action_data.get("categoria", "comercios")
