    ...
    return {
        ...
        "panel_sections": [
            ...
            },
            {
                ...
                "widgets": ["guardians", "students", "family_context"],
            },
            {
                "id": "school_cases",
                ...
                "secondary_endpoints": ["/api/v1/education/cases?envelope=1"],
                "capability": "education.cases",
                "widgets": ["case_list", "case_detail", "assignment"],
            },
            {
                "id": "school_structure",
                ...
                "secondary_endpoints": ["/api/v1/education/campuses", "/api/v1/education/sections"],
                "capability": "education.structure",
                "widgets": ["schools", "campuses", "sections"],
            },
            {
                "id": "whatsapp_school",
                ...
                "widgets": ["whatsapp_menu", "media_rules", "handoff_rules"],
            },
        ],
        "profile_fields": [
