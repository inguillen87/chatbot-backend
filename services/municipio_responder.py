...
def _build_confirmation_aliases() -> dict[str, str]:
    ...
    alias_pairs = [
        ...
        ("reclamo_confirmar_si", "reclamo_confirmar_si"),
        ...
        ("reclamo_confirmar_no", "reclamo_confirmar_no"),
        ("3", "reclamo_cancelar"),
        ...
        ("reclamo_cancelar", "reclamo_cancelar"),
    ]
...
class ReclamoFlowHandler:
    ...
    def end_flow(self, message, show_menu=False, image_url=None):
        ...
        # Clear any legacy LLM flags so numeric shortcuts work immediately in
        # future turns without requiring a fresh handler instantiation.
        for legacy_key in (
            "esperando_info_llm",
            "esperando_info_llm_reclamo",
            "datos_parciales_llm_reclamo",
            ...
            self.municipal_ctx.pop(legacy_key, None)
