...
from routes.v2.demo import demo_compat_bp, v2_demo_bp
from routes.v2.health import v2_health_bp
from routes.v2.government_launch import v2_government_launch_bp
from routes.v2.interviews import v2_interviews_bp
...
def register_v2_blueprints(app):
    ...
    app.register_blueprint(v2_government_launch_bp)
    app.register_blueprint(v2_interviews_bp)
